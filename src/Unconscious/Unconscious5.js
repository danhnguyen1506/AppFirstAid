            ...
            return (
              <View style={styles.container}>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Unconscious6')}
                 style={styles.button}>
                    <Image style={styles.image} source={require('../../assets/image/nannhannamsap.jpg')} position='absolute'/>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Unconscious7')}
                 style={styles.button}>
                    <Image style={styles.image} source={require('../../assets/image/tuthephuctap.jpg')} position='absolute'/>
                    <View style={styles.overlay}/>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Unconscious9')}
                 style={styles.button}>
                    <Image style={styles.image} source={require('../../assets/image/khongchanthuongco.jpg')} position='absolute'/>
                    <View style={styles.overlay}/>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Unconscious8')}
                 style={styles.button}>
                    <Image style={styles.image} source={require('../../assets/image/cochanthuongco.jpg')} position='absolute'/>
                    <View style={styles.overlay}/>
