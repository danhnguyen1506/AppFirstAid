            ...
            return (
              <View style={styles.container}>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Bite2')}
                 style={styles.button}>
                    <Image style={styles.image} source={require('../../assets/image/ongchich.jpg')} position='absolute'/>
                    <View style={styles.overlay}/>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Bite3')}
                 style={styles.button}>
                    <Image style={styles.image} source={require('../../assets/image/sinhvatbiencan.jpg')} position='absolute'/>
                    <View style={styles.overlay}/>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Bite4')}
                 style={styles.button}>
                    <Image style={styles.image} source={require('../../assets/image/dogbite.jpg')} position='absolute'/>
                    <View style={styles.overlay}/>
