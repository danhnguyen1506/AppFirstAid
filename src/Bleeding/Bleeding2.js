            ...
            return (
              <View style={styles.container}>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Bleeding3')}
                 style={styles.button}>
                    <Image style={styles.image} source={require('../../assets/image/vetcatsauochi.jpg')} position='absolute'/>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Bleeding4')}
                 style={styles.button}>
                    <Image style={styles.image} source={require('../../assets/image/vetcatsauotran.jpg')} position='absolute'/>
                    <View style={styles.overlay}/>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Bleeding5')}
                 style={styles.button}>
                    <Image style={styles.image} source={require('../../assets/image/vetcatsauoco.jpg')} position='absolute'/>
                    <View style={styles.overlay}/>
