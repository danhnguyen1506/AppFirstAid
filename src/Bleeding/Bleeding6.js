            ...
            return (
              <View style={styles.container}>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Bleeding8')}
                 style={styles.button}>
                    <Image style={styles.image} source={require('../../assets/image/damvaomat.jpg')} position='absolute'/>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Bleeding7')}
                 style={styles.button}>
                    <Image style={styles.image} source={require('../../assets/image/damvaocothe.jpg')} position='absolute'/>
                    <View style={styles.overlay}/>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Bone3')}
                 style={styles.button}>
                    <Image style={styles.image} source={require('../../assets/image/gayxuongho.jpg')} position='absolute'/>
                    <View style={styles.overlay}/>
