            ...
            return (
              <View style={styles.container}>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Bleeding2')}
                 style={styles.button}>
                    <Image style={styles.image} source={require('../../assets/image/vetcatsau.jpg')} position='absolute'/>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Bleeding6')}
                 style={styles.button}>
                    <Image style={styles.image} source={require('../../assets/image/vetdamxuyen.jpg')} position='absolute'/>
                    <View style={styles.overlay}/>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Bleeding11')}
                 style={styles.button}>
                    <Image style={styles.image} source={require('../../assets/image/dutliangon.jpg')} position='absolute'/>
                    <View style={styles.overlay}/>
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Bleeding12')}
                 style={styles.button}>
                    <Image style={styles.image} source={require('../../assets/image/chaymaumui.jpg')} position='absolute'/>
                    <View style={styles.overlay}/>
