                ...
                <View style={commonStyles.slide1}>
                  ...
                  <View style={{flexDirection:'column', marginBottom: 20}}>
                    ...
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('Chocking5')}
                      style={styles.button}>
                        <Image style={styles.image} source={require('../../assets/image/hocnguoilon.jpg')} position='absolute'/>
                    ...
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('Chocking4')}
                      style={styles.button}>
                        <Image style={styles.image} source={require('../../assets/image/hoctresosinh.jpg')} position='absolute'/>
                        <View style={styles.overlay}/>
