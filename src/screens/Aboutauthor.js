            ...
            <ScrollView>
              <View style={styles.container}>
                ...
                <View style={styles.button}>
                    <Image style={styles.image} source={require('../../assets/image/hothaibinh.jpg')} position='absolute'/>
                ...
                <View style={styles.button}>
                    <Image style={styles.image} source={require('../../assets/image/tonycoffey.jpg')} position='absolute'/>
                    <View style={styles.viewText}>
                ...
                <View style={styles.button}>
                    <Image style={styles.image} source={require('../../assets/image/trangjenanguyen.jpg')} position='absolute'/>
                    <View style={styles.viewText}>
                ...
                <View style={styles.button}>
                    <Image style={styles.image} source={require('../../assets/image/trantrieungoahuyen.jpg')} position='absolute'/>
                    <View style={styles.viewText}>
                ...
                <View style={styles.button}>
                    <Image style={styles.image} source={require('../../assets/image/trung.jpg')} position='absolute'/>
                    <View style={styles.viewText}>
